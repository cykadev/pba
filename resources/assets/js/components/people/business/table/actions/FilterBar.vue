<template>
    <div class="filter-bar">
      <form class="form-inline">
        <div class="form-group">
          ...
          <input type="text" v-model="query" class="form-control" @keyup="doFilter" placeholder="Title">
    ...
    <button type="button" class="mb-xs mt-xs mr-xs btn btn-default dropdown-toggle" data-toggle="dropdown" :aria-expanded="(active) ? 'true' : 'false'"> Search In <span class="caret"></span></button>
      ...
      <li><a tabindex="0"><label class="checkbox"><input name="category" type="radio" v-model="category" value="category"> Category</label></a></li>
      <li><a tabindex="0"><label class="checkbox"><input name="category" type="radio" v-model="category" value="group"> Group</label></a></li>
