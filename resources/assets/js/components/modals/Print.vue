          ...
          <div class="modal-content">
            <div class="modal-body" style="padding:0px;">
              <div class="col-md-4 col-xs-4 col-lg-4 col-sm-4" style="border-right:1px dashed black">
                ...
                <template v-if="printvalues.Mode == 'receipt' || printvalues.Mode == 'cheque'">
                <div style="margin-bottom:7px;">
                  <template v-if="printvalues.Mode == 'receipt'">
                  ...
                  <template v-if="printvalues.Mode == 'cheque'">
                  <p style="margin:0 0 10px;line-height:4px;">Payment Mode: Cheque</p>
                  <p style="margin:0 0 10px;line-height:4px;">Cheque #: {{printvalues.Check}}</p>
                  </template>
                </div>
...
cancelPrint(){
// EventBus.$emit('proceeded-to-print', '');
